...
mod tests {
    ...
    /// The decoder-level keepalive fix is covered in `stream.rs`; this pins the
    /// same behavior on the buffered path, which reassembles the whole body
    /// instead of dispatching frame by frame.
    #[test]
